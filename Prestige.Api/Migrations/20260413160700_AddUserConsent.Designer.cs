...
namespace Prestige.Api.Migrations
{
    ...
    [Migration("20260413160700_AddUserConsent")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prestige.Api.Domain.ConsentEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prestige.Api.Domain.ImportHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("MaxTimestamp")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("MinTimestamp")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Prestige.Api.Domain.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("PersonalScore")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("Prestige.Api.Domain.RatingCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Prestige.Api.Domain.RatingComparison", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId", "ItemType", "ComparisonDate");

                    b.ToTable("RatingComparisons");
                });
            ...
            modelBuilder.Entity("Prestige.Api.Domain.UserAlbum", b =>
                {
                    ...
                    b.HasIndex("TotalTime")
                        .HasDatabaseName("IX_UserAlbum_TotalTime");

                    b.HasIndex("UserId", "TotalTime")
            ...
            modelBuilder.Entity("Prestige.Api.Domain.UserConsent", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<bool>("AllowsAnonymizedAggregation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AllowsDerivedFeatureStorage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("AllowsModelTraining")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("AllowsPersonalInsights")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Prestige.Api.Domain.ConsentEvent", b =>
                {
                    b.HasOne("Prestige.Api.Domain.UserConsent", null)
                        .WithMany("History")
            ...
            modelBuilder.Entity("Prestige.Api.Domain.Rating", b =>
                {
                    b.HasOne("Prestige.Api.Domain.RatingCategory", "Category")
                        .WithMany()
